...
public class ScaleView2 extends ImageView implements OnGlobalLayoutListener, OnScaleGestureListener, OnTouchListener {
    ...
    public ScaleView2(Context context, AttributeSet attrs, int defStyle) {
